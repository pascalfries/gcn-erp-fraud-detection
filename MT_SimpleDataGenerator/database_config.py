...
table_sales.add_columns([DataColumn('id', True), DataColumn('description'), DataColumn('customer_id', is_hidden=True), DataColumn('salesperson_id', is_hidden=True), DataColumn('timestamp', is_timestamp=True)])
